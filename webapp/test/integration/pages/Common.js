sap.ui.define([
	...
	function getFrameUrl (sHash, sUrlParameters) {
		var sUrl = jQuery.sap.getResourcePath("Pizza/BestInPizza/app", ".html");
		sHash = sHash || "";
	...
	return Opa5.extend("Pizza.BestInPizza.test.integration.pages.Common", {
		...
		getMockServer : function () {
			return new Promise(function (success) {
				Opa5.getWindow().sap.ui.require(["Pizza/BestInPizza/localService/mockserver"], function (mockserver) {
